...
class EnergyDemandEnv:
  ...
  def __init__(self, data, cluster, test_cluster, test_cluster_two, which_cluster, test_data,test_data_two, capacities):
...
def main():
  ...
  env = EnergyDemandEnv(data, cluster, test_cluster,test_cluster_two, which_cluster,test_data,test_data_two, capacities)
